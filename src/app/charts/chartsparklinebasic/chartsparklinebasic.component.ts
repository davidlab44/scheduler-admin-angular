...
@Component({
  selector: 'app-chartsparklinebasic',
  templateUrl: './chartsparklinebasic.component.html',
  styleUrls: ['./chartsparklinebasic.component.css'],
})
export class ChartsparklinebasicComponent {
